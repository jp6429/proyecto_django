...
urlpatterns = [
    ...
    path('mascots/detail/<str:mascotas_id>', mascots_detail, name="mascots-detail"),
    path('mascots/edit/<str:mascotas_id>', mascots_update, name="mascots-edit"),
    path('mascots/new/', mascots_new, name="mascots-new"),
    path('mascots/mascotType/<mascotType>', mascots_by_mascotType, name="mascots-mascotType"),
